...
"stage": {
   ...
   content: {
         dom: [
         {
            ...
            fill:["rgba(0,0,0,0)",im+"pizarron.png",'0px','0px']
         },
         {
            id:'Group',
            type:'group',
            ...
            },
            {
               ...
               text:"¡Bien ! Ahora si el número de figura lo llamamos “n” ¿Cuántos elementos tiene?<br><br><br>",
               align:"center",
         ...
         },
         {
            ...
            },
            {
               ...
               type:'text',
               rect:['14px','30px','458px','140px','auto','auto'],
               text:"No te preocupes regresemos un poco…<br><br>",
               align:"center",
               font:['Fabada-regular',26,"rgba(255,255,255,1.00)","normal","none",""],
               textShadow:["rgba(0,0,0,0.65)",3,3,3],
               transform:[]
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid1994", tween: [ "style", "${_grupo2}", "display", 'block', { fromValue: 'none'}], position: 9500, duration: 0 },
            ...
            { id: "eid1989", tween: [ "style", "${_Group}", "display", 'none', { fromValue: 'block'}], position: 9500, duration: 0 }         ]
      }
   }
},
"robot": {
   ...
   dom: [
   {
      ...
      fill: ['rgba(0,0,0,0)','images/body_rb.png','0px','0px']
   },
   {
      id: 'brazo_derrb',
      type: 'image',
      rect: ['0px','107px','43px','120px','auto','auto'],
      fill: ['rgba(0,0,0,0)','images/brazo_derrb.png','0px','0px']
   },
   {
      id: 'brazo_izqrb',
      type: 'image',
      rect: ['159px','106px','43px','118px','auto','auto'],
      fill: ['rgba(0,0,0,0)','images/brazo_izqrb.png','0px','0px']
   },
   {
      type: 'group',
      id: 'grupo_cabz',
      ...
      c: [
      {
         ...
         fill: ['rgba(0,0,0,0)','images/cab_rob.png','0px','0px']
      },
      {
         id: 'rostro',
         type: 'rect',
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid2036", tween: [ "style", "${_brazo_izqrb}", "-moz-transform-origin", [32.21,12.66], { valueTemplate: '@@0@@% @@1@@%', fromValue: [32.21,12.66]}], position: 0, duration: 0, easing: "easeOutBack" },
            { id: "eid2037", tween: [ "style", "${_brazo_izqrb}", "-ms-transform-origin", [32.21,12.66], { valueTemplate: '@@0@@% @@1@@%', fromValue: [32.21,12.66]}], position: 0, duration: 0, easing: "easeOutBack" },
            { id: "eid2038", tween: [ "style", "${_brazo_izqrb}", "msTransformOrigin", [32.21,12.66], { valueTemplate: '@@0@@% @@1@@%', fromValue: [32.21,12.66]}], position: 0, duration: 0, easing: "easeOutBack" },
            { id: "eid2039", tween: [ "style", "${_brazo_izqrb}", "-o-transform-origin", [32.21,12.66], { valueTemplate: '@@0@@% @@1@@%', fromValue: [32.21,12.66]}], position: 0, duration: 0, easing: "easeOutBack" },
...
"rostro": {
   ...
   dom: [
   {
      ...
      fill: ['rgba(0,0,0,0)','images/boca_rb.png','0px','0px']
   },
   {
      id: 'ojo_rb',
      type: 'image',
      rect: ['0px','0px','27px','35px','auto','auto'],
      fill: ['rgba(0,0,0,0)','images/ojo_rb.png','0px','0px']
   },
   {
      id: 'ojo_rbCopy',
      type: 'image',
