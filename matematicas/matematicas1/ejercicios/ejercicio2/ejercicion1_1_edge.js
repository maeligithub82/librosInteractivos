...
"stage": {
   ...
   content: {
         ...
         },
         {
            ...
            text:"¡¡ Otro reto !!<br>1._Observa el comportamiento de las siguientes figuras:",
            align:"left",
         ...
         },
         {
            ...
            display:'none',
            type:'text',
            rect:['71px','327px','721px','69px','auto','auto'],
            text:"De acuerdo a la secuencia de imágenes selecciona la imagen que corresponde a la figura 5 de las opciones que se muestran a continuación ",
            align:"left",
         ...
         },
         {
            ...
            display:'none',
            type:'image',
            rect:['100px','158px','700px','120px','auto','auto'],
         ...
         },
         {
            ...
            display:'none',
            type:'image',
            rect:['47px','410px','260px','150px','auto','auto'],
         ...
         },
         {
            ...
            display:'none',
            type:'image',
            rect:['307px','410px','260px','150px','auto','auto'],
         ...
         },
         {
            ...
            display:'none',
            type:'image',
            rect:['596px','410px','260px','150px','auto','auto'],
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid161", tween: [ "style", "${_f2}", "left", '347px', { fromValue: '357px'}], position: 4593, duration: 157 },
            ...
            { id: "eid162", tween: [ "style", "${_f1}", "left", '67px', { fromValue: '97px'}], position: 4593, duration: 157 },
            ...
            { id: "eid163", tween: [ "style", "${_f3}", "left", '581px', { fromValue: '646px'}], position: 4593, duration: 157 },
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid1813", tween: [ "style", "${_brazo_izqrb}", "-moz-transform-origin", [32.21,12.66], { valueTemplate: '@@0@@% @@1@@%', fromValue: [32.21,12.66]}], position: 0, duration: 0, easing: "easeOutBack" },
            { id: "eid1814", tween: [ "style", "${_brazo_izqrb}", "-ms-transform-origin", [32.21,12.66], { valueTemplate: '@@0@@% @@1@@%', fromValue: [32.21,12.66]}], position: 0, duration: 0, easing: "easeOutBack" },
            { id: "eid1815", tween: [ "style", "${_brazo_izqrb}", "msTransformOrigin", [32.21,12.66], { valueTemplate: '@@0@@% @@1@@%', fromValue: [32.21,12.66]}], position: 0, duration: 0, easing: "easeOutBack" },
            { id: "eid1816", tween: [ "style", "${_brazo_izqrb}", "-o-transform-origin", [32.21,12.66], { valueTemplate: '@@0@@% @@1@@%', fromValue: [32.21,12.66]}], position: 0, duration: 0, easing: "easeOutBack" },
            ...
            { id: "eid1817", tween: [ "style", "${_grupo_cabz}", "-moz-transform-origin", [160.14,147.44], { valueTemplate: '@@0@@% @@1@@%', fromValue: [160.14,147.44]}], position: 2500, duration: 0 },
            { id: "eid1818", tween: [ "style", "${_grupo_cabz}", "-ms-transform-origin", [160.14,147.44], { valueTemplate: '@@0@@% @@1@@%', fromValue: [160.14,147.44]}], position: 2500, duration: 0 },
            { id: "eid1819", tween: [ "style", "${_grupo_cabz}", "msTransformOrigin", [160.14,147.44], { valueTemplate: '@@0@@% @@1@@%', fromValue: [160.14,147.44]}], position: 2500, duration: 0 },
            { id: "eid1820", tween: [ "style", "${_grupo_cabz}", "-o-transform-origin", [160.14,147.44], { valueTemplate: '@@0@@% @@1@@%', fromValue: [160.14,147.44]}], position: 2500, duration: 0 },
...
"robot_error": {
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            { id: "eid394", tween: [ "style", "${_brazo_izqrb}", "-webkit-transform-origin", [32.21,12.66], { valueTemplate: '@@0@@% @@1@@%', fromValue: [32.21,12.66]}], position: 0, duration: 0, easing: "easeOutBack" },
            { id: "eid1821", tween: [ "style", "${_brazo_izqrb}", "-moz-transform-origin", [32.21,12.66], { valueTemplate: '@@0@@% @@1@@%', fromValue: [32.21,12.66]}], position: 0, duration: 0, easing: "easeOutBack" },
            { id: "eid1822", tween: [ "style", "${_brazo_izqrb}", "-ms-transform-origin", [32.21,12.66], { valueTemplate: '@@0@@% @@1@@%', fromValue: [32.21,12.66]}], position: 0, duration: 0, easing: "easeOutBack" },
            { id: "eid1823", tween: [ "style", "${_brazo_izqrb}", "msTransformOrigin", [32.21,12.66], { valueTemplate: '@@0@@% @@1@@%', fromValue: [32.21,12.66]}], position: 0, duration: 0, easing: "easeOutBack" },
            { id: "eid1824", tween: [ "style", "${_brazo_izqrb}", "-o-transform-origin", [32.21,12.66], { valueTemplate: '@@0@@% @@1@@%', fromValue: [32.21,12.66]}], position: 0, duration: 0, easing: "easeOutBack" },
