...
"stage": {
   ...
   content: {
         ...
         },
         {
            ...
            text:"Conexión con: Historia, geografía  y Fc y E.<br>",
            align:"center",
         ...
         },
         {
            ...
            text:"1.\tPara activar conocimientos previos efectuar las siguientes preguntas:<br>-¿Han escuchado hablar a alguien de Veracruz?<br>-¿De México D.F?<br>-¿A un cubano?<br>-¿A un español?<br>-¿Por qué la ONU declaró al Español una de las lenguas oficiales de ese organismo?<br>",
            align:"left",
            font:['Fabada-regular',18,"rgba(255,255,255,1.00)","normal","none",""],
            textShadow:["rgba(0,0,0,0.65)",3,3,3]
         },
         {
            id:'especificacion',
            ...
            text:"2.- Entregar a cada alumno el articulo informativo “En México se dice”<br>",
            align:"left",
            font:['Fabada-regular',18,"rgba(255,255,255,1.00)","normal","none",""],
            textShadow:["rgba(0,0,0,0.65)",3,3,3]
         },
         {
            ...
            opacity:1,
            text:"3.-Invitar a los alumnos a leer el texto e indicarles que se hara en voz alta.<br>(se pretende que un alumno lea en voz alta y el resto seguirá la lectura en silencio)<br><br>",
            align:"left",
            font:['Fabada-regular',18,"rgba(255,255,255,1.00)","normal","none",""],
            textShadow:["rgba(0,0,0,0.65)",3,3,3]
         },
         {
            ...
            rect:['71px','371px','761px','47px','auto','auto'],
            opacity:1,
            text:"<br>4.- Explicar a los alumnos que de acuerdo con la información del texto “En México se dice”, completar la siguiente tabla de léxico utilizado en algunos países hispanohablantes.<br>(Solamente escribir en los espacios en blanco)<br><br><br>",
            align:"left",
            font:['Fabada-regular',18,"rgba(255,255,255,1.00)","normal","none",""],
            textShadow:["rgba(0,0,0,0.65)",3,3,3]
         },
   ...
   states: {
      "Base State": {
         ...
         "${_robot}": [
            ["style", "top", '-266.35px'],
            ["transform", "scaleY", '0.79035'],
            ["style", "display", 'none'],
            ["style", "left", '-22.42px'],
            ["transform", "scaleX", '0.79035']
         ],
         "${_caminar}": [
            ["style", "display", 'none'],
            ["style", "top", '315px']
         ...
         "${_introduccion}": [
            ...
            ["style", "top", '-97px'],
            ["style", "text-align", 'left'],
            ["style", "height", '186.66662597656px'],
            ["subproperty", "textShadow.color", 'rgba(0,0,0,0.648438)'],
            ["subproperty", "textShadow.blur", '3px'],
            ["style", "opacity", '0']
         ],
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid2854", tween: [ "style", "${_especificacion2}", "opacity", '0', { fromValue: '1'}], position: 32000, duration: 750 },
            { id: "eid142", tween: [ "style", "${_mono_desenfoque}", "display", 'none', { fromValue: 'block'}], position: 750, duration: 0 },
            { id: "eid2870", tween: [ "style", "${_especificacion3}", "opacity", '1', { fromValue: '0'}], position: 32830, duration: 1013 },
            { id: "eid2892", tween: [ "transform", "${_robot}", "scaleY", '0.79035', { fromValue: '0.79035'}], position: 10000, duration: 0, easing: "easeInOutElastic" },
            { id: "eid168", tween: [ "style", "${_Text}", "opacity", '1', { fromValue: '0'}], position: 3500, duration: 750 },
            { id: "eid2150", tween: [ "style", "${_Text}", "opacity", '0.15723270440252', { fromValue: '1'}], position: 32000, duration: 750 },
            { id: "eid2866", tween: [ "style", "${_especificacion3}", "top", '68px', { fromValue: '68px'}], position: 32830, duration: 0 },
            { id: "eid2646", tween: [ "style", "${_especificacion}", "opacity", '1', { fromValue: '0'}], position: 4407, duration: 933 },
            { id: "eid2849", tween: [ "style", "${_especificacion}", "opacity", '0', { fromValue: '1'}], position: 32000, duration: 750 },
            { id: "eid2632", tween: [ "style", "${_especificacion2}", "top", '377px', { fromValue: '-56px'}], position: 5140, duration: 1110 },
            { id: "eid2653", tween: [ "style", "${_especificacion2}", "top", '362px', { fromValue: '377px'}], position: 6250, duration: 181 },
            { id: "eid2891", tween: [ "transform", "${_robot}", "scaleX", '0.79035', { fromValue: '0.79035'}], position: 10000, duration: 0, easing: "easeInOutElastic" },
            { id: "eid141", tween: [ "style", "${_mono_desenfoque2}", "display", 'none', { fromValue: 'block'}], position: 500, duration: 0 },
            { id: "eid2893", tween: [ "style", "${_robot}", "left", '-22.42px', { fromValue: '-22.42px'}], position: 10000, duration: 0, easing: "easeInOutElastic" },
            { id: "eid2647", tween: [ "style", "${_especificacion}", "top", '319px', { fromValue: '-40px'}], position: 4407, duration: 933 },
            { id: "eid2648", tween: [ "style", "${_especificacion}", "top", '306px', { fromValue: '319px'}], position: 5340, duration: 160 },
            { id: "eid2720", tween: [ "style", "${_robot}", "top", '447.47px', { fromValue: '-266.35px'}], position: 4750, duration: 5250, easing: "easeInOutElastic" },
            ...
            { id: "eid2865", tween: [ "style", "${_especificacion3}", "height", '131.07779312134px', { fromValue: '131.07779312134px'}], position: 32830, duration: 0 },
            { id: "eid2148", tween: [ "style", "${_Text}", "left", '621px', { fromValue: '71px'}], position: 32000, duration: 750 },
            ...
            { id: "eid2155", tween: [ "style", "${_introduccion}", "opacity", '0', { fromValue: '1'}], position: 32000, duration: 750 },
            ...
            { id: "eid2151", tween: [ "style", "${_Text}", "display", 'none', { fromValue: 'block'}], position: 32750, duration: 0 },
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid2918", tween: [ "style", "${_brazo_izqrb}", "-moz-transform-origin", [32.21,12.66], { valueTemplate: '@@0@@% @@1@@%', fromValue: [32.21,12.66]}], position: 0, duration: 0, easing: "easeOutBack" },
            { id: "eid2919", tween: [ "style", "${_brazo_izqrb}", "-ms-transform-origin", [32.21,12.66], { valueTemplate: '@@0@@% @@1@@%', fromValue: [32.21,12.66]}], position: 0, duration: 0, easing: "easeOutBack" },
            { id: "eid2920", tween: [ "style", "${_brazo_izqrb}", "msTransformOrigin", [32.21,12.66], { valueTemplate: '@@0@@% @@1@@%', fromValue: [32.21,12.66]}], position: 0, duration: 0, easing: "easeOutBack" },
            { id: "eid2921", tween: [ "style", "${_brazo_izqrb}", "-o-transform-origin", [32.21,12.66], { valueTemplate: '@@0@@% @@1@@%', fromValue: [32.21,12.66]}], position: 0, duration: 0, easing: "easeOutBack" },
            ...
            { id: "eid2922", tween: [ "style", "${_grupo_cabz}", "-moz-transform-origin", [160.14,147.44], { valueTemplate: '@@0@@% @@1@@%', fromValue: [160.14,147.44]}], position: 2500, duration: 0 },
            { id: "eid2923", tween: [ "style", "${_grupo_cabz}", "-ms-transform-origin", [160.14,147.44], { valueTemplate: '@@0@@% @@1@@%', fromValue: [160.14,147.44]}], position: 2500, duration: 0 },
            { id: "eid2924", tween: [ "style", "${_grupo_cabz}", "msTransformOrigin", [160.14,147.44], { valueTemplate: '@@0@@% @@1@@%', fromValue: [160.14,147.44]}], position: 2500, duration: 0 },
            { id: "eid2925", tween: [ "style", "${_grupo_cabz}", "-o-transform-origin", [160.14,147.44], { valueTemplate: '@@0@@% @@1@@%', fromValue: [160.14,147.44]}], position: 2500, duration: 0 },
