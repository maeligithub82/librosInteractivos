...
var habili = function(){
	...
	var urlS=s('next');
	//LO COMENTO ROCÍO PARA QUE DEJE PASAR AL SIGUIENTE EJERCICIO SIN TENER QUE LLENAR EL CUADRO.
	//if(s('r1').disabled && s('r2').disabled && s('r3').disabled && s('r4').disabled  &&s('r5').disabled && s('r6').disabled && s('r7').disabled && s('r3').disabled){
		s('next').disabled = true;
	//}else{
	//	apprise('¡El valor de el campo  debe ser correcto, no estar vacío!');
	//	return false;
	//}
}
